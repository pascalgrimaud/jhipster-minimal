...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserDTO managedUserDTO) {
        ...
        UserEntity userEntity = userApplicationService.registerUser(managedUserDTO, managedUserDTO.getPassword());
    ...
    public void finishPasswordReset(@RequestBody KeyAndPasswordDTO keyAndPassword) {
        ...
        Optional<UserEntity> user = userApplicationService.completePasswordReset(keyAndPassword.getNewPassword(), keyAndPassword.getKey());
